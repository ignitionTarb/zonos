...
function sendZonosUpdateTracking(orderId, trackingList) {
	var zonosService = require('*/cartridge/scripts/services/ZonosUpdateTrackingService');
...
module.exports = {
	...
	sendZonosUpdateTracking: sendZonosUpdateTracking,
	getTax: getTax
}
