...
// This never gets called in Autobahn. Cartridge originally designed to work against base SFRA.
server.append('PlaceOrder', server.middleware.https, function (req, res, next) {
    ...
    if (currentSite.getCustomPreferenceValue('zonos_enabled')) {
        ...
        var zonosResponse = Zonos.sendZonosOrderData(orderId);
        
        var Transaction = require('dw/system/Transaction');
        var OrderMgr = require('dw/order/OrderMgr');
        var order = OrderMgr.getOrder(orderId);
		Transaction.wrap(function () {
			order.custom.zonosOrderId = zonosResponse.object.zonos_order_id;
		});
    }
